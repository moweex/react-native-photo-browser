...
export default class Photo extends Component {
  ...
  _renderProgressIndicator() {
    ...
    if (progress < 1) {
      ...
      if (Platform.OS === "android") {
        return <ActivityIndicator color="#616161" animating={true} />;
      }
      ...
      const ProgressElement = useCircleProgress
        ...
        : Progress.Bar;
      return (
        <ProgressElement progress={progress} thickness={20} color={"#616161"} />
      );
    }
    return null;
  }
  ...
  render() {
    const { resizeMode, width, height, id, setChildRef } = this.props;
    ...
    return (
      <View style={[styles.container, sizeStyle]}>
        ...
        {/* {loading ? this._renderProgressIndicator() : null} */}
        <PhotoView
          source={source}
          ref={setChildRef}
          id={id}
